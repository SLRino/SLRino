...
while True:
    def switch():
            ...
            if operation==1:
                ...
                print("operation to be performed : 10")
                user_1=str(input("Enter user 1 :"))
                user_2=str(input("Enter user 2 :"))
                for x in listname1:
                    if x==user_2 or x==user_1:
                        print("Top most common boss :",listname1)
                        break
                for x in listname2:
                    if x==user_2 or x==user_1:
                        print("Top most common boss :",listname1)
