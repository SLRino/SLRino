'''With a user name find the number of users between the top most role user and the entered user i.e number of users between the user with root role and the entered user (include root role users also).'''
...
while True:
    def switch():
            ...
            if operation==1:
                ...
                for x in listname1:    #FIND THE USER ROLE
                    if x==usr_name:    #IF ROOT ROLE
                        print(" This is the root user ")
                for x in listname2:    #IF SUB ROLE OF CEO
                    if x==usr_name:
                        print("Number of users from top : 0 ")
                for x in listname3:   #IF SUB ROLE OF COO
                    if x==usr_name:
                        print("Number of users from top : 1 ")
                for x in listname44:   #IF SUB ROLE OF CTO
                    if x==usr_name:
